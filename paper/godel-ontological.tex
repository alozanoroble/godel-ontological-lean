...
weaker logic $B$ suffices for Theorem 3, and Benzm\"uller, Weber and
Woltzenlogel Paleo~\cite{bww2017} report it automated in $KB$ --- and further
report A4 and A5 \emph{redundant} for this emendation, derivable from the rest.
